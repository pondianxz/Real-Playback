tellraw @a {"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n◆ Deleted Keyframe 1","color":"red"}
tag @e[type=marker,tag=anchor] remove RTC.KF.no_remove
execute at @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 1"}'}] run scoreboard players reset @e[type=marker,tag=anchor,sort=nearest,limit=1] RTC_camera
execute at @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 1"}'}] run kill @e[type=marker,tag=anchor,sort=nearest,limit=1]
execute as @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 1"}'}] run kill @s

scoreboard players remove @e[type=marker,tag=anchor] RTC_camera 1
scoreboard players remove .every RTC_camera 1
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 2"}'}] CustomName set from storage rtc_keyframes:aec customname1
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 3"}'}] CustomName set from storage rtc_keyframes:aec customname2
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 4"}'}] CustomName set from storage rtc_keyframes:aec customname3
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 5"}'}] CustomName set from storage rtc_keyframes:aec customname4
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 6"}'}] CustomName set from storage rtc_keyframes:aec customname5
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 7"}'}] CustomName set from storage rtc_keyframes:aec customname6
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 8"}'}] CustomName set from storage rtc_keyframes:aec customname7
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 9"}'}] CustomName set from storage rtc_keyframes:aec customname8
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 10"}'}] CustomName set from storage rtc_keyframes:aec customname9
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 11"}'}] CustomName set from storage rtc_keyframes:aec customname10
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 12"}'}] CustomName set from storage rtc_keyframes:aec customname11
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 13"}'}] CustomName set from storage rtc_keyframes:aec customname12
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 14"}'}] CustomName set from storage rtc_keyframes:aec customname13
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 15"}'}] CustomName set from storage rtc_keyframes:aec customname14
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 16"}'}] CustomName set from storage rtc_keyframes:aec customname15
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 17"}'}] CustomName set from storage rtc_keyframes:aec customname16
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 18"}'}] CustomName set from storage rtc_keyframes:aec customname17
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 19"}'}] CustomName set from storage rtc_keyframes:aec customname18
data modify entity @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 20"}'}] CustomName set from storage rtc_keyframes:aec customname19
