tellraw @a {"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n◆ Deleted Keyframe 48","color":"red"}
tag @e[type=marker,tag=anchor] remove RTC.KF.no_remove
execute at @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 48"}'}] run scoreboard players reset @e[type=marker,tag=anchor,sort=nearest,limit=1] RTC_camera
execute at @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 48"}'}] run kill @e[type=marker,tag=anchor,sort=nearest,limit=1]
execute as @e[type=area_effect_cloud,limit=1,nbt={CustomName:'{"color":"green","text":"Keyframe 48"}'}] run kill @s
