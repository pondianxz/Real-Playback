...
execute store result storage rtc_bezier:math Q1.Pos[0] double .01 run data get entity @e[tag=bezier.Q1,limit=1] Pos[0] 100
execute store result storage rtc_bezier:math Q1.Pos[1] double .01 run data get entity @e[tag=bezier.Q1,limit=1] Pos[1] 100
execute store result storage rtc_bezier:math Q1.Pos[2] double .01 run data get entity @e[tag=bezier.Q1,limit=1] Pos[2] 100
execute store result score .Q0x RTC_bezier_math run data get entity @e[tag=bezier.Q0,limit=1] Pos[0] 100
execute store result score .Q0y RTC_bezier_math run data get entity @e[tag=bezier.Q0,limit=1] Pos[1] 100
execute store result score .Q0z RTC_bezier_math run data get entity @e[tag=bezier.Q0,limit=1] Pos[2] 100
execute store result score .Q1x RTC_bezier_math run data get storage rtc_bezier:math Q1.Pos[0] 100
execute store result score .Q1y RTC_bezier_math run data get storage rtc_bezier:math Q1.Pos[1] 100
execute store result score .Q1z RTC_bezier_math run data get storage rtc_bezier:math Q1.Pos[2] 100
...
execute store result entity @e[type=marker,tag=bezier.C0,limit=1] Pos[0] double .0001 run scoreboard players get .C0_x RTC_bezier_math
execute store result entity @e[type=marker,tag=bezier.C0,limit=1] Pos[1] double .0001 run scoreboard players get .C0_y RTC_bezier_math
execute store result entity @e[type=marker,tag=bezier.C0,limit=1] Pos[2] double .0001 run scoreboard players get .C0_z RTC_bezier_math