...
execute store result storage rtc_bezier:math L1.Pos[0] double .01 run data get entity @e[tag=bezier.L1,limit=1] Pos[0] 100
execute store result storage rtc_bezier:math L1.Pos[1] double .01 run data get entity @e[tag=bezier.L1,limit=1] Pos[1] 100
execute store result storage rtc_bezier:math L1.Pos[2] double .01 run data get entity @e[tag=bezier.L1,limit=1] Pos[2] 100
execute store result score .L0x RTC_bezier_math run data get entity @e[type=area_effect_cloud,nbt={CustomName:'{"color":"green","text":"Keyframe 1"}'},limit=1] Pos[0] 100
execute store result score .L0y RTC_bezier_math run data get entity @e[type=area_effect_cloud,nbt={CustomName:'{"color":"green","text":"Keyframe 1"}'},limit=1] Pos[1] 100
execute store result score .L0z RTC_bezier_math run data get entity @e[type=area_effect_cloud,nbt={CustomName:'{"color":"green","text":"Keyframe 1"}'},limit=1] Pos[2] 100
execute store result score .L1x RTC_bezier_math run data get storage rtc_bezier:math L1.Pos[0] 100
execute store result score .L1y RTC_bezier_math run data get storage rtc_bezier:math L1.Pos[1] 100
execute store result score .L1z RTC_bezier_math run data get storage rtc_bezier:math L1.Pos[2] 100
...
execute store result entity @e[type=marker,tag=bezier.Q0,limit=1] Pos[0] double .0001 run scoreboard players get .Q0_x RTC_bezier_math
execute store result entity @e[type=marker,tag=bezier.Q0,limit=1] Pos[1] double .0001 run scoreboard players get .Q0_y RTC_bezier_math
execute store result entity @e[type=marker,tag=bezier.Q0,limit=1] Pos[2] double .0001 run scoreboard players get .Q0_z RTC_bezier_math