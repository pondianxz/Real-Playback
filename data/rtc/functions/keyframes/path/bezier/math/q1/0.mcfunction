...
execute store result storage rtc_bezier:math L2.Pos[0] double .01 run data get entity @e[tag=bezier.L2,limit=1] Pos[0] 100
execute store result storage rtc_bezier:math L2.Pos[1] double .01 run data get entity @e[tag=bezier.L2,limit=1] Pos[1] 100
execute store result storage rtc_bezier:math L2.Pos[2] double .01 run data get entity @e[tag=bezier.L2,limit=1] Pos[2] 100
#
#
#
execute store result score .L2x RTC_bezier_math run data get storage rtc_bezier:math L2.Pos[0] 100
execute store result score .L2y RTC_bezier_math run data get storage rtc_bezier:math L2.Pos[1] 100
execute store result score .L2z RTC_bezier_math run data get storage rtc_bezier:math L2.Pos[2] 100
...
execute store result entity @e[type=marker,tag=bezier.Q1,limit=1] Pos[0] double .0001 run scoreboard players get .Q1_x RTC_bezier_math
execute store result entity @e[type=marker,tag=bezier.Q1,limit=1] Pos[1] double .0001 run scoreboard players get .Q1_y RTC_bezier_math
execute store result entity @e[type=marker,tag=bezier.Q1,limit=1] Pos[2] double .0001 run scoreboard players get .Q1_z RTC_bezier_math